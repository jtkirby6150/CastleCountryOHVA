...
?>
    <div class="container">
        ...
        <p style="text-align: center;margin: 50px;">We want to express our gratitude to the men and women of these organizations that continue to sponsor our efforts. Thank you!!!</p>
        <h3 style="text-align: center;">Our Sponsors</h3>
        <section>
            <div class="container">
                <div class="row">
                    <?php
                    $sql = query("SELECT * FROM sponsors");
