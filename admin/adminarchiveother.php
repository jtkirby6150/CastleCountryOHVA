...
if(isset($_GET['archive'])){
    ...
    $getEvent = query("SELECT * FROM otherevents WHERE id = '$id'");
...
if(isset($_GET['updatearchive'])){
    ...
    $getEvent = query("SELECT * FROM otherarchives WHERE id = '$id'");
...
if(isset($_POST['updatearchive'])){
    ...
    if ($_FILES['image1']['name']) {
        ...
        $getOldImage = query("SELECT * FROM otherarchives WHERE id = '$id'");
    ...
    $updateArchive = query("UPDATE otherarchives SET description = '$newdescription', image1 = '$img1', image2 = '$img2', image3 = '$img3', image4 = '$img4', image5 = '$img5', image6 = '$img6', image7 = '$img7', image8 = '$img8', image9 = '$img9', image10 = '$img10', image11 = '$img11', image12 = '$img12', image13 = '$img13', image14 = '$img14', image15 = '$img15' WHERE id = '$archiveid' ");
...
?>
    <div class="container">
        <h1 style="text-align: center;margin: 50px auto;">Other Archive</h1>
        <?php display_message(); ?>
